 ...
 */
class bourgeaabox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "bourgeaa@bourgeaa";
    public $boxlabel;
    public $depends = array("bourgeaa");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/bourgeaa/class/bourgeaa.class.php";
